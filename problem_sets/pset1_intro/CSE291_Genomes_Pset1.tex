...
All homework should be sent to mgymrek@ucsd.edu with subject line \textcolor{purple}{[CSE291 PS1:LASTNAME]} by the beginning of class on \textbf{Tuesday, January 10}. % TODO where to find data/tools
% module load bedtools
% module load tabix
% module load bcftools
% module load python # to get python2.7
% PyVCF install?
